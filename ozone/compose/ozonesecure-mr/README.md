...
```
cd $(git rev-parse --show-toplevel)/hadoop-ozone/dist/target/ozone-2.2.0-SNAPSHOT/compose/ozonesecure-mr
...
export HADOOP_CLASSPATH=$HADOOP_CLASSPATH:/opt/hadoop/share/hadoop/mapreduce/*:/opt/ozone/share/ozone/lib/ozone-filesystem-lib-current-2.2.0-SNAPSHOT.jar
